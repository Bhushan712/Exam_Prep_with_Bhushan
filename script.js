...
function renderMenu() {
  ...
  root.innerHTML = `
    ...
    <footer class="credit">Built by <a href="https://linkedin.com/in/bhushanpatil-id" target="_blank" rel="noopener">Bhushan Patil</a>, Instructional Designer · scores are stored only in your browser</footer>
  `;
